...
const TOOLS_MAP: Record<string, ComponentType> = {
  ...
  "color-converter": dynamic(() => import("@/components/tools/color-converter"), { loading }),
  "cron-parser": dynamic(() => import("@/components/tools/cron-parser"), { loading }),
  ...
  "dns-lookup": dynamic(() => import("@/components/tools/dns-lookup"), { loading }),
  ...
  "image-to-pdf": dynamic(() => import("@/components/tools/image-to-pdf"), { loading }),
  ...
  "number-base-converter": dynamic(() => import("@/components/tools/number-base-converter"), { loading }),
  ...
  "pdf-merge": dynamic(() => import("@/components/tools/pdf-merge"), { loading }),
  "pdf-metadata": dynamic(() => import("@/components/tools/pdf-metadata"), { loading }),
  "pdf-rotate": dynamic(() => import("@/components/tools/pdf-rotate"), { loading }),
  "pdf-split": dynamic(() => import("@/components/tools/pdf-split"), { loading }),
  ...
  "robots-txt-analyzer": dynamic(() => import("@/components/tools/robots-txt-analyzer"), { loading }),
  ...
  "text-case-converter": dynamic(() => import("@/components/tools/text-case-converter"), { loading }),
  ...
  "totp-generator": dynamic(() => import("@/components/tools/totp-generator"), { loading }),
  ...
  "whois-lookup": dynamic(() => import("@/components/tools/whois-lookup"), { loading }),
